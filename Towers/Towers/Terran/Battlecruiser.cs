    ...
    public class Battlecruiser:ModTower<TerranSet>{
        ...
        public class TowerManagerUpgradeTower_Patch{
            ...
            public static void Postfix(ref Tower tower){
                if(tower.towerModel.tier==2&&tower.namedMonkeyKey.Contains("Battlecruiser")){
                    tower.Node.graphic.GetComponent<Animator>().Play("BattlecruiserYamatoTransition");
                }
            }
        }
        ...
        public class ResourceLoaderLoadSpriteFromSpriteReferenceAsync_Patch{
            ...
            public static void Postfix(SpriteReference reference,ref Image image){
                if(reference!=null&&reference.guidRef.StartsWith("Battlecruiser")){
        ...
        public class WeaponSpawnDart_Patch{
            ...
            public static void Postfix(ref Weapon __instance){
                if(__instance.attack.tower.towerModel.name.StartsWith("SC2Expansion-Battlecruiser")&&__instance.attack.attackModel.name.Contains("Yamato")){
                    __instance.attack.tower.Node.graphic.GetComponent<Animator>().Play("BattlecruiserYamato");
